                ...
                <div class="card author-box">
                  <div class="card-body">
                    <div class="author-box-center">
                      <img alt="image" src="./images/users/<?= $_SESSION['image'] ?>" class="rounded-circle author-box-picture " >
                      ...
                      <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <div class="row">
                          ...
                          <div class="col-md-3 col-6 b-r">
                            ...
                            <br>
                            <p class="text-muted"><?= $_SESSION['phone'] ?></p>
                          </div>
                          <div class="col-md-3 col-6 b-r">
                            <strong>Email</strong>
                            <br>
                          ...
                          <div class="col-md-3 col-6">
                            ...
                            <br>
                            <p class="text-muted"><?= $_SESSION['address']  ?></p>
                          </div>
                        </div>
