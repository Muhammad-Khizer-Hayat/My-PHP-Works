...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($data['errors'] === false) {
        ...
        $insert_query = "INSERT INTO users ( `username`, `email`, `password`, `phone`, `address`,`description`, `image`)
            VALUES ('$_POST[name]','$_POST[email]' ,'$_POST[password]','$_POST[phone]','$_POST[address]','$_POST[description]','$name') ";
//  echo $insert_query;
//  exit;
