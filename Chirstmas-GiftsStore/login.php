...
?>
          <div class="card border border-light-subtle rounded-3 shadow-sm">
            <div class="card-body p-3 p-md-4 p-xl-5">
              ...
              <h3 class=" fw-normal text-center text-primary mb-4"><strong>Login Form</strong></h3>
                ...
                <div class="row gy-2 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="d-flex gap-2 justify-content-between">
                      ...
                      <a href="./admin/forgot-password.php" class="link-primary text-decoration-none">Forgot password?</a>
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="d-grid my-3">
                      <button class="btn btn-primary btn-sm w-100" type="submit" name="submit" value="login">Log in</button>
                    </div>
                  </div>
                  <div class="col-12">
